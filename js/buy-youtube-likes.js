...
const serviceUrl = "/v1/user/sendPaymentMailForYoutubeLikes";
...
const addUser = () => {
    ...
    const userInfo = user;
    axios.post(apiUrl + '/user/youtubeLikes/add', userInfo).then((res) => {
        axios.post(apiUrl + '/user/youtubeLikes/sendYoutubeLikesLead', userInfo).then((res) => {
...
const sendMailAfterPayment = () => {
    ...
    user.totalAmount = totalAmount;
    const userData = user;
    const apiUrl = "https://real-subscribers-server.onrender.com/v1/user/sendPaymentMailForYoutubeLikes";
    // const apiUrl = "http://localhost:3000/v1/user/sendPaymentMailForYoutubeLikes";
